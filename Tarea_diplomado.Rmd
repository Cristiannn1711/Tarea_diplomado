...
```
#Incluya una tabla con los estimadores puntuales de los promedios y las varianzas de la variable Final_Weight_g para cada nivel del factor Cepa, incluya tambien el N muestral. Use el paquete dplyr y los comandos group_by(), summarise().